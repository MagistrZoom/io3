...
HD_PWD='/home/izoomko/wrk/4grade/io/lab3/lab2.runs/uc_system_Timer_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uc_system_Timer_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uc_system_Timer_0_2.tcl

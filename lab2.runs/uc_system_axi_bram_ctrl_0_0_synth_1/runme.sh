...
HD_PWD='/home/izoomko/wrk/4grade/io/lab3/lab2.runs/uc_system_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uc_system_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uc_system_axi_bram_ctrl_0_0.tcl

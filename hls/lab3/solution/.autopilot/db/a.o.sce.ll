...
define void @"Timer::on_clock"(i1* %clk_i, i1* %rst_i, i1* %en_i, i13* %addr_bi, i32* %data_bi, i4* %we_bi, i16* %data_bo, i32* %Timer_m_tmr_V, i32* %Timer_m_tval_V, i32* %Timer_m_tconf_V) {
  ...
  call void @llvm.dbg.value(metadata !{i1* %clk_i}, i64 0, metadata !164), !dbg !2332
  call void @llvm.dbg.value(metadata !{i1* %rst_i}, i64 0, metadata !2333), !dbg !2332
  call void @llvm.dbg.value(metadata !{i1* %en_i}, i64 0, metadata !2334), !dbg !2332
  call void @llvm.dbg.value(metadata !{i13* %addr_bi}, i64 0, metadata !2335), !dbg !2332
  call void @llvm.dbg.value(metadata !{i32* %data_bi}, i64 0, metadata !2351), !dbg !2332
  call void @llvm.dbg.value(metadata !{i4* %we_bi}, i64 0, metadata !2361), !dbg !2332
  call void @llvm.dbg.value(metadata !{i16* %data_bo}, i64 0, metadata !2377), !dbg !2332
  call void @llvm.dbg.value(metadata !{i32* %Timer_m_tmr_V}, i64 0, metadata !2391), !dbg !2332
  call void @llvm.dbg.value(metadata !{i32* %Timer_m_tval_V}, i64 0, metadata !2401), !dbg !2332
  call void @llvm.dbg.value(metadata !{i32* %Timer_m_tconf_V}, i64 0, metadata !2402), !dbg !2332
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [7 x i8]* @p_str3, [6 x i8]* @p_str2, i32 0, i32 0, i1* %clk_i) nounwind, !dbg !2403
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [7 x i8]* @p_str3, [6 x i8]* @p_str4, i32 0, i32 0, i1* %rst_i) nounwind, !dbg !2405
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [7 x i8]* @p_str3, [5 x i8]* @p_str5, i32 0, i32 0, i1* %en_i) nounwind, !dbg !2406
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [12 x i8]* @p_str6, [8 x i8]* @p_str7, i32 0, i32 0, i13* %addr_bi) nounwind, !dbg !2407
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [6 x i8]* @p_str8, [8 x i8]* @p_str9, i32 0, i32 0, i32* %data_bi) nounwind, !dbg !2408
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [11 x i8]* @p_str10, [6 x i8]* @p_str11, i32 0, i32 0, i4* %we_bi) nounwind, !dbg !2409
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 1, [11 x i8]* @p_str12, [8 x i8]* @p_str13, i32 0, i32 0, i16* %data_bo) nounwind, !dbg !2410
  call void (...)* @_ssdm_op_SpecProcessDef([6 x i8]* @p_str, i32 0, [9 x i8]* @p_str1) nounwind, !dbg !2411
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([10 x i8]* @p_str18), !dbg !2412
  call void (...)* @_ssdm_op_SpecProtocol(i32 1) nounwind, !dbg !2413
  call void @llvm.dbg.value(metadata !{i1* %en_i}, i64 0, metadata !2414), !dbg !2422
  %tmp = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %en_i), !dbg !2430
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !2432), !dbg !2423
  %Timer_m_tmr_V_read = call i32 @_ssdm_op_Read.ap_auto.i32P(i32* %Timer_m_tmr_V), !dbg !2433
  %t_V = call i32 @_ssdm_op_Read.ap_auto.i32P(i32* %Timer_m_tval_V), !dbg !2442
  call void @llvm.dbg.value(metadata !{i32 %t_V}, i64 0, metadata !2704), !dbg !2708
  br i1 %tmp, label %1, label %5, !dbg !2429

; <label>:1                                       ; preds = %0
  call void @llvm.dbg.value(metadata !{i32* %data_bi}, i64 0, metadata !2711), !dbg !2718
  %tmp_12 = call i32 @_ssdm_op_Read.ap_auto.volatile.i32P(i32* %data_bi), !dbg !2727
  call void @llvm.dbg.value(metadata !{i32 %tmp_12}, i64 0, metadata !2729), !dbg !2719
  call void @llvm.dbg.value(metadata !{i32 %tmp_12}, i64 0, metadata !2730), !dbg !2725
  call void @llvm.dbg.value(metadata !{i13* %addr_bi}, i64 0, metadata !2731), !dbg !2740
  %val_V = call i13 @_ssdm_op_Read.ap_auto.volatile.i13P(i13* %addr_bi), !dbg !2748
  call void @llvm.dbg.value(metadata !{i13 %val_V}, i64 0, metadata !2750), !dbg !2748
...
; <label>:2                                       ; preds = %1
  %tmp_6 = trunc i32 %tmp_12 to i16, !dbg !2753
  call void @llvm.dbg.value(metadata !{i16 %tmp_6}, i64 0, metadata !2755), !dbg !2757
  call void @llvm.dbg.value(metadata !{i16 %tmp_6}, i64 0, metadata !2758), !dbg !2760
  call void @llvm.dbg.value(metadata !{i16 %tmp_6}, i64 0, metadata !2762), !dbg !2764
  %p_s = zext i16 %tmp_6 to i32, !dbg !2766
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %Timer_m_tmr_V, i32 %p_s), !dbg !2768
  br label %._crit_edge, !dbg !2771

; <label>:3                                       ; preds = %1
  %tmp_7 = trunc i32 %tmp_12 to i16, !dbg !2772
  call void @llvm.dbg.value(metadata !{i16 %tmp_7}, i64 0, metadata !2755), !dbg !2773
  call void @llvm.dbg.value(metadata !{i16 %tmp_7}, i64 0, metadata !2758), !dbg !2774
  call void @llvm.dbg.value(metadata !{i16 %tmp_7}, i64 0, metadata !2762), !dbg !2776
  %p_1 = zext i16 %tmp_7 to i32, !dbg !2778
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %Timer_m_tval_V, i32 %p_1), !dbg !2779
  br label %._crit_edge, !dbg !2780

; <label>:4                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i32 %tmp_12}, i64 0, metadata !2781), !dbg !2783
  call void @llvm.dbg.value(metadata !{i32 %tmp_12}, i64 0, metadata !2785), !dbg !2787
  call void @llvm.dbg.value(metadata !{i32 %tmp_12}, i64 0, metadata !2789), !dbg !2791
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %Timer_m_tconf_V, i32 %tmp_12), !dbg !2793
  br label %._crit_edge, !dbg !2794

; <label>:5                                       ; preds = %0
  call void @llvm.dbg.value(metadata !{i1* %rst_i}, i64 0, metadata !2414), !dbg !2795
  %tmp_5 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %rst_i), !dbg !2799
  call void @llvm.dbg.value(metadata !{i1 %tmp_5}, i64 0, metadata !2432), !dbg !2796
  br i1 %tmp_5, label %6, label %7, !dbg !2798

; <label>:6                                       ; preds = %5
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %Timer_m_tval_V, i32 0), !dbg !2800
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %Timer_m_tmr_V, i32 0), !dbg !2803
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %Timer_m_tconf_V, i32 0), !dbg !2805
  br label %._crit_edge, !dbg !2807

; <label>:7                                       ; preds = %5
  %Timer_m_tconf_V_read = call i32 @_ssdm_op_Read.ap_auto.i32P(i32* %Timer_m_tconf_V), !dbg !2808
  %tmp_8 = trunc i32 %Timer_m_tconf_V_read to i1, !dbg !2829
  %tmp_10 = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %Timer_m_tconf_V_read, i32 1), !dbg !2829
  br i1 %tmp_10, label %._crit_edge, label %_ifconv, !dbg !2828

_ifconv:                                          ; preds = %7
  %tmp_9 = icmp eq i32 %t_V, 0, !dbg !2442
  %tmp_1 = add i32 %t_V, -1, !dbg !2832
  %Timer_m_tmr_V_load_t = select i1 %tmp_9, i32 %Timer_m_tmr_V_read, i32 %tmp_1, !dbg !2702
  call void @llvm.dbg.value(metadata !{i32 %t_V}, i64 0, metadata !3087), !dbg !3091
  %tmp_s = icmp ult i32 %t_V, %Timer_m_tmr_V_read, !dbg !2433
  %tmp_4 = add i32 %t_V, 1, !dbg !3094
  %tmp_4_s = select i1 %tmp_s, i32 %tmp_4, i32 0, !dbg !2438
  %storemerge2 = select i1 %tmp_8, i32 %tmp_4_s, i32 %Timer_m_tmr_V_load_t
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %Timer_m_tval_V, i32 %storemerge2), !dbg !3098
  br label %._crit_edge, !dbg !3101

._crit_edge:                                      ; preds = %7, %_ifconv, %6, %4, %3, %2, %1
  %Timer_m_tval_V_loc_3 = phi i32 [ %t_V, %1 ], [ %t_V, %4 ], [ %p_1, %3 ], [ %t_V, %2 ], [ 0, %6 ], [ %storemerge2, %_ifconv ], [ %t_V, %7 ]
  %v = trunc i32 %Timer_m_tval_V_loc_3 to i16, !dbg !3102
  call void @llvm.dbg.value(metadata !{i16 %v}, i64 0, metadata !3103), !dbg !3110
  call void @llvm.dbg.value(metadata !{i16* %data_bo}, i64 0, metadata !3114), !dbg !3121
  call void @_ssdm_op_Write.ap_auto.volatile.i16P(i16* %data_bo, i16 %v), !dbg !3123
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([10 x i8]* @p_str18, i32 %tmp_3), !dbg !3125
  ret void, !dbg !3126
}
...
define void @"Timer::Timer"(i1* %clk_i, i1* %rst_i, i1* %en_i, i13* %addr_bi, i32* %data_bi, i4* %we_bi, i16* %data_bo, i32* %Timer_m_tmr_V, i32* %Timer_m_tval_V, i32* %Timer_m_tconf_V) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %Timer_m_tval_V), !map !156
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %Timer_m_tconf_V), !map !160
  call void @llvm.dbg.value(metadata !{i1* %clk_i}, i64 0, metadata !3127), !dbg !3130
  call void @llvm.dbg.value(metadata !{i1* %rst_i}, i64 0, metadata !3131), !dbg !3130
  call void @llvm.dbg.value(metadata !{i1* %en_i}, i64 0, metadata !3132), !dbg !3130
  call void @llvm.dbg.value(metadata !{i13* %addr_bi}, i64 0, metadata !3133), !dbg !3130
  call void @llvm.dbg.value(metadata !{i32* %data_bi}, i64 0, metadata !3134), !dbg !3130
  call void @llvm.dbg.value(metadata !{i4* %we_bi}, i64 0, metadata !3135), !dbg !3130
  call void @llvm.dbg.value(metadata !{i16* %data_bo}, i64 0, metadata !3136), !dbg !3130
  call void @llvm.dbg.value(metadata !{i32* %Timer_m_tmr_V}, i64 0, metadata !3137), !dbg !3130
  call void @llvm.dbg.value(metadata !{i32* %Timer_m_tval_V}, i64 0, metadata !3138), !dbg !3130
  call void @llvm.dbg.value(metadata !{i32* %Timer_m_tconf_V}, i64 0, metadata !3139), !dbg !3130
  call void (...)* @_ssdm_op_SpecTopModule([6 x i8]* @p_str, [6 x i8]* @p_str) nounwind, !dbg !3140
  %Timer_ssdm_thread = load i1* @Timer_ssdm_thread_M_on_clock, align 1, !dbg !3142
  br i1 %Timer_ssdm_thread, label %1, label %._crit_edge, !dbg !3142

; <label>:1                                       ; preds = %0
  call void @"Timer::on_clock"(i1* %clk_i, i1* %rst_i, i1* %en_i, i13* %addr_bi, i32* %data_bi, i4* %we_bi, i16* %data_bo, i32* %Timer_m_tmr_V, i32* %Timer_m_tval_V, i32* %Timer_m_tconf_V), !dbg !3143
  br label %._crit_edge, !dbg !3143

._crit_edge:                                      ; preds = %1, %0
  call void (...)* @_ssdm_op_SpecProcessDecl([6 x i8]* @p_str, i32 0, [9 x i8]* @p_str1) nounwind, !dbg !3144
  call void (...)* @_ssdm_op_SpecSensitive([9 x i8]* @p_str1, [6 x i8]* @p_str2, i1* %clk_i, i32 1) nounwind, !dbg !3145
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [7 x i8]* @p_str3, [6 x i8]* @p_str2, i32 0, i32 0, i1* %clk_i) nounwind, !dbg !3146
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [7 x i8]* @p_str3, [6 x i8]* @p_str4, i32 0, i32 0, i1* %rst_i) nounwind, !dbg !3147
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [7 x i8]* @p_str3, [5 x i8]* @p_str5, i32 0, i32 0, i1* %en_i) nounwind, !dbg !3148
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [12 x i8]* @p_str6, [8 x i8]* @p_str7, i32 0, i32 0, i13* %addr_bi) nounwind, !dbg !3149
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [6 x i8]* @p_str8, [8 x i8]* @p_str9, i32 0, i32 0, i32* %data_bi) nounwind, !dbg !3150
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 0, [11 x i8]* @p_str10, [6 x i8]* @p_str11, i32 0, i32 0, i4* %we_bi) nounwind, !dbg !3151
  call void (...)* @_ssdm_op_SpecPort([6 x i8]* @p_str, i32 1, [11 x i8]* @p_str12, [8 x i8]* @p_str13, i32 0, i32 0, i16* %data_bo) nounwind, !dbg !3152
  ret void, !dbg !3153
}

...
################################################################
# This is a generated script based on design: uc_system
#
...
CONFIG.POLARITY {ACTIVE_LOW} \
  ...
  set block_cell_name BRAMInterconnect_0
  if { [catch {set BRAMInterconnect_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
...
CONFIG.NUM_MI {4} \
  ...
  # Create port connections
  connect_bd_net -net BRAMInterconnect_0_bram_addr_o [get_bd_pins BRAMInterconnect_0/bram_addr_o] [get_bd_pins Timer_0/addr_bi] [get_bd_pins Timer_1/addr_bi]
  connect_bd_net -net BRAMInterconnect_0_bram_rddata_a [get_bd_pins BRAMInterconnect_0/bram_rddata_a] [get_bd_pins axi_bram_ctrl_0/bram_rddata_a]
  connect_bd_net -net BRAMInterconnect_0_bram_wrdata_o [get_bd_pins BRAMInterconnect_0/bram_wrdata_o] [get_bd_pins Timer_0/data_bi] [get_bd_pins Timer_1/data_bi]
  connect_bd_net -net BRAMInterconnect_0_en_timer0 [get_bd_pins BRAMInterconnect_0/en_timer0] [get_bd_pins Timer_0/en_i]
  connect_bd_net -net BRAMInterconnect_0_en_timer1 [get_bd_pins BRAMInterconnect_0/en_timer1] [get_bd_pins Timer_1/en_i]
  connect_bd_net -net BRAMInterconnect_0_rd_timer0 [get_bd_pins BRAMInterconnect_0/rd_timer0] [get_bd_pins Timer_0/rd_i]
  connect_bd_net -net BRAMInterconnect_0_rd_timer1 [get_bd_pins BRAMInterconnect_0/rd_timer1] [get_bd_pins Timer_1/rd_i]
  connect_bd_net -net BRAMInterconnect_0_rst_timer0 [get_bd_pins BRAMInterconnect_0/rst_timer0] [get_bd_pins Timer_0/rst_i]
  connect_bd_net -net BRAMInterconnect_0_rst_timer1 [get_bd_pins BRAMInterconnect_0/rst_timer1] [get_bd_pins Timer_1/rst_i]
  connect_bd_net -net BRAMInterconnect_0_wr_timer0 [get_bd_pins BRAMInterconnect_0/wr_timer0] [get_bd_pins Timer_0/wr_i]
  connect_bd_net -net BRAMInterconnect_0_wr_timer1 [get_bd_pins BRAMInterconnect_0/wr_timer1] [get_bd_pins Timer_1/wr_i]
  connect_bd_net -net Timer_0_data_bo [get_bd_ports timer0] [get_bd_pins Timer_0/data_bo]
  connect_bd_net -net Timer_1_data_bo [get_bd_ports timer1] [get_bd_pins Timer_1/data_bo]
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_pins BRAMInterconnect_0/bram_addr_a] [get_bd_pins axi_bram_ctrl_0/bram_addr_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_clk_a [get_bd_pins BRAMInterconnect_0/bram_clk_i] [get_bd_pins Timer_0/clk_i] [get_bd_pins Timer_1/clk_i] [get_bd_pins axi_bram_ctrl_0/bram_clk_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_en_a [get_bd_pins BRAMInterconnect_0/bram_en_a] [get_bd_pins axi_bram_ctrl_0/bram_en_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_rst_a [get_bd_pins BRAMInterconnect_0/bram_rst_a] [get_bd_pins axi_bram_ctrl_0/bram_rst_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_we_a [get_bd_pins BRAMInterconnect_0/bram_we_a] [get_bd_pins axi_bram_ctrl_0/bram_we_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_wrdata_a [get_bd_pins BRAMInterconnect_0/bram_wrdata_a] [get_bd_pins axi_bram_ctrl_0/bram_wrdata_a]
